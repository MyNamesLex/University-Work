...
class BezierPatch : public GeometryHelper
{
    ...
    float BernsteinPoly(int i, float x)
    {
    ...
    float BernsteinPolyDiff(int i, float x)
    {
    ...
    void EvaluateBezierPoint(float u, float v, const std::vector<glm::vec3>& cp, glm::vec3& pos, glm::vec3& norm, glm::vec3& tangent)
    {
        pos = glm::vec3();
        tangent = glm::vec3();
        glm::vec3 bitangent;
