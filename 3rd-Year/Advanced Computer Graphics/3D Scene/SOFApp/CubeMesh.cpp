...
CubeMesh::CubeMesh(const std::string& meshFile)
{
    Load(meshFile);
}

void CubeMesh::Draw(const Transforms& trans, const PointLight& light)
{
...
void CubeMesh::Load(const std::string& fileName)
{
