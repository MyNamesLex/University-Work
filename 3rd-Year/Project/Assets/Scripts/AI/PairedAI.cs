...
public class PairedAI : MonoBehaviour
{
    public NavMeshAgent nma;
    public NavMeshAgent nma2;
    ...
    void Update()
    {
        if (HitCollider1 == false)
        {
            ...
            nma2.SetDestination(Collider1Pos.transform.position);
        }
        else if (HitCollider1 == true)
        {
            nma.SetDestination(Collider2Pos.transform.position);
            nma2.SetDestination(Collider2Pos.transform.position);
        }
    }
